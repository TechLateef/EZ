...
## [0.4.0](https://github.com/TechLateef/EZ/compare/grayscale-v0.3.0...grayscale-v0.4.0) (2026-08-11)


### Features

* --emit-c writes generated C to file instead of stdout ([#2049](https://github.com/TechLateef/EZ/issues/2049)) ([78281c7](https://github.com/TechLateef/EZ/commit/78281c7648cfc9dcfdeaaf9cd1ec15f4a4dab952))
* add `else` as syntax alias for `otherwise` ([#1974](https://github.com/TechLateef/EZ/issues/1974)) ([dc91535](https://github.com/TechLateef/EZ/commit/dc91535f54d1f4907e21ec102547361dd730c2d4))
* add arrays.any() and arrays.all() higher-order functions ([#2000](https://github.com/TechLateef/EZ/issues/2000)) ([c079b62](https://github.com/TechLateef/EZ/commit/c079b624940b7790b3feab2137799a7e8f572bbf))
* add atomic.spinlock_destroy() to free spinlock memory ([#1721](https://github.com/TechLateef/EZ/issues/1721)) ([32da8e5](https://github.com/TechLateef/EZ/commit/32da8e52335bb760281762cffffb8fc365c7a239))
* add channels.try_send() and channels.try_receive() for non-blocking ops ([#2003](https://github.com/TechLateef/EZ/issues/2003)) ([9ae9c02](https://github.com/TechLateef/EZ/commit/9ae9c025b8623598bd7baf48de677c76d233ba71))
* add custom request headers support to http module ([#1994](https://github.com/TechLateef/EZ/issues/1994)) ([d8b5c03](https://github.com/TechLateef/EZ/commit/d8b5c03761f4a4b728d6faca3bd7c856a3a2b89e))
* add helpful hints to 10 common compiler error messages ([#1566](https://github.com/TechLateef/EZ/issues/1566)) ([0a97a94](https://github.com/TechLateef/EZ/commit/0a97a941d8063bc2ab964b0b17a75df24e97fcea))
* add os.unset_env() to remove environment variables ([#2002](https://github.com/TechLateef/EZ/issues/2002)) ([b2c074d](https://github.com/TechLateef/EZ/commit/b2c074d351aa2797327662f44c6456872db59259))
* add strings.char_at() to get a character at a given index ([#1998](https://github.com/TechLateef/EZ/issues/1998)) ([1769f30](https://github.com/TechLateef/EZ/commit/1769f30464d2dc4a00459a33842241cad403429d))
* add strings.last_index_of() to find the last occurrence of a substring ([#1996](https://github.com/TechLateef/EZ/issues/1996)) ([aa1fd95](https://github.com/TechLateef/EZ/commit/aa1fd95983e98001588ead8fb3d9bb6b18ef6aed))
* add strings.remove_prefix() and strings.remove_suffix() ([#1997](https://github.com/TechLateef/EZ/issues/1997)) ([ab606c6](https://github.com/TechLateef/EZ/commit/ab606c641587ebe1616586f8705243626f467a11))
* add strings.to_chars() and strings.from_chars() for string/char array conversion ([#1999](https://github.com/TechLateef/EZ/issues/1999)) ([73bc156](https://github.com/TechLateef/EZ/commit/73bc156dc07ff9e649ccadb7504b140b3549a27e))
* add time.diff() to return the difference between two timestamps ([#1993](https://github.com/TechLateef/EZ/issues/1993)) ([dd007d5](https://github.com/TechLateef/EZ/commit/dd007d5301be54f1b41bb40f98547da0158a3156))
* add type-level generic parameters via &lt;?&gt; syntax ([#1797](https://github.com/TechLateef/EZ/issues/1797)) ([aecbdec](https://github.com/TechLateef/EZ/commit/aecbdec5fa574ec8af6ae70528554877aa3cc862))
* add Windows support ([#1342](https://github.com/TechLateef/EZ/issues/1342)) ([e41ba3d](https://github.com/TechLateef/EZ/commit/e41ba3dbb4fd277fc5e04890966b61cd759477bd))
* allow compile-time integer constants as fixed-size array size specifiers ([#1958](https://github.com/TechLateef/EZ/issues/1958)) ([0933931](https://github.com/TechLateef/EZ/commit/09339314b0e920a0f0bc82c0d820edf1ddfff852))
* **builtin:** extend new() to support all types ([#2193](https://github.com/TechLateef/EZ/issues/2193)) ([6e62ec7](https://github.com/TechLateef/EZ/commit/6e62ec771ea78a201471d79c5f6cc8669031d3f0))
* **cli:** add cross-compilation support via zig cc ([#2093](https://github.com/TechLateef/EZ/issues/2093)) ([ff6a08e](https://github.com/TechLateef/EZ/commit/ff6a08eab365eaec70a6319d5ab9731485718252))
* **compiler:** add platform abstraction layer for OS-specific calls ([#1342](https://github.com/TechLateef/EZ/issues/1342)) ([063cd77](https://github.com/TechLateef/EZ/commit/063cd77e6966da87b6592551c43bd166002b00c0))
* **compiler:** compile Grayscale programs to binaries on Windows ([#1342](https://github.com/TechLateef/EZ/issues/1342)) ([bcb2236](https://github.com/TechLateef/EZ/commit/bcb2236dc6c32b5d74e34002d9ce18915e598338))
* **compiler:** port the compiler driver to the platform layer ([#1342](https://github.com/TechLateef/EZ/issues/1342)) ([f3ac3eb](https://github.com/TechLateef/EZ/commit/f3ac3ebccd95972050c7de87107f0641fec7a2e8))
* **lang:** add type aliasing with `alias` keyword ([#2136](https://github.com/TechLateef/EZ/issues/2136)) ([6d244d8](https://github.com/TechLateef/EZ/commit/6d244d8fde5710d60732e2e3b0ac12c28bcbba06))
* make `map` keyword optional — allow `[K:V]` syntax ([#1961](https://github.com/TechLateef/EZ/issues/1961)) ([8546d82](https://github.com/TechLateef/EZ/commit/8546d82d026d525e16b9942900a43d20dbf01d45))
* **runtime:** add platform compat headers for the runtime and stdlib ([#1342](https://github.com/TechLateef/EZ/issues/1342)) ([7a2e6d5](https://github.com/TechLateef/EZ/commit/7a2e6d5b4bbb0e5614fe30a0bc4f7bc645dd8e53))
* **scripts:** add PowerShell build and test scripts for Windows ([#1342](https://github.com/TechLateef/EZ/issues/1342)) ([7572b27](https://github.com/TechLateef/EZ/commit/7572b275d9de7b5fd95992b8045e145fda517182))
* **stdlib/io:** support globbing and directory creation on Windows ([#1342](https://github.com/TechLateef/EZ/issues/1342)) ([23e3bd2](https://github.com/TechLateef/EZ/commit/23e3bd2e2210018d633aabbaad2b33476aea72ed))
* **stdlib/os:** support env, cwd, hostname, and pid on Windows ([#1342](https://github.com/TechLateef/EZ/issues/1342)) ([efb4373](https://github.com/TechLateef/EZ/commit/efb4373236444f22ef720cdc87d3796c28aceb65))
* **stdlib:** add `write_bytes()`, `append_bytes()`, `temp_file()`, `temp_dir()` to `io` module ([6e761f5](https://github.com/TechLateef/EZ/commit/6e761f59a39e0062b1ec72d0dbd79d85ef5c68f8))
* **stdlib:** add support for regex, net,os and server stdlib modules ([#1342](https://github.com/TechLateef/EZ/issues/1342)) ([e00ad7c](https://github.com/TechLateef/EZ/commit/e00ad7c1c549f369fade51b116d51d002589d4b2))
* **stdlib:** add write_bytes, append_bytes, temp_file, temp_dir to io module ([#1868](https://github.com/TechLateef/EZ/issues/1868)) ([5875f3e](https://github.com/TechLateef/EZ/commit/5875f3e8775ddfefe73d7ec7ce176d0f06e35157))


### Bug Fixes

* add 30s timeout to integration tests to prevent CI hangs ([a6764bf](https://github.com/TechLateef/EZ/commit/a6764bf7bfc11d7b93431153950e42ddf869d4d0))
* add depth limit to json.is_valid to prevent stack overflow on deeply nested input ([#2020](https://github.com/TechLateef/EZ/issues/2020)) ([0914ab7](https://github.com/TechLateef/EZ/commit/0914ab70c955166ed93e90f760b4fc2760c55563))
* add optional host parameter to net.listen() and server.listen() to allow interface-specific binding ([#2017](https://github.com/TechLateef/EZ/issues/2017)) ([63e84e6](https://github.com/TechLateef/EZ/commit/63e84e6e37d01f6fd33be293064711f2a96b883e))
* add scope_destroy() to release scope memory at all typechecker call sites ([b6a1ac6](https://github.com/TechLateef/EZ/commit/b6a1ac6a680402b8debe9b4d7f1812a594641147))
* add type_pool_reset() to free heap strings from type pool on shutdown ([f9ef806](https://github.com/TechLateef/EZ/commit/f9ef806a08b0338d0d6766e86adf1456f650e1d9))
* add typechecker_free() and typetable_free() to release typechecker memory ([dce12dc](https://github.com/TechLateef/EZ/commit/dce12dc12ab8fb72bec24c79f06b6e9da6d9fc2a))
* allow local consts as fixed-size array sizes ([#2070](https://github.com/TechLateef/EZ/issues/2070)) ([e6bda10](https://github.com/TechLateef/EZ/commit/e6bda100c26da2cd5d9ab2efc969c8127dd347ea))
* **build:** make install work on Windows ([7580baf](https://github.com/TechLateef/EZ/commit/7580baf71a68893d7eb26160cfd081ab02d076aa))
* cap HTTP server at 1024 concurrent connections and apply 30s read timeout per connection ([#2011](https://github.com/TechLateef/EZ/issues/2011)) ([7d2d30d](https://github.com/TechLateef/EZ/commit/7d2d30d29b2a81cd139dddd4ec8a60c509408d46))
* cap os.exec stdout/stderr collection at 64 MiB per stream to prevent memory exhaustion ([#2010](https://github.com/TechLateef/EZ/issues/2010)) ([ae9b26d](https://github.com/TechLateef/EZ/commit/ae9b26db48c628769a33671682a73e39de62c7b6))
* catch channels.send/try_send type mismatch and resolve module-qualified Channel type ([#1989](https://github.com/TechLateef/EZ/issues/1989)) ([e9b281c](https://github.com/TechLateef/EZ/commit/e9b281cee423f40892023a86a1ad2d21cf818109))
* char/byte array literals use correct elem_size in codegen ([#2066](https://github.com/TechLateef/EZ/issues/2066)) ([41c1302](https://github.com/TechLateef/EZ/commit/41c1302511bf1c8f16aad80c39e10c26e15e0203))
* **ci:** add grayscale prefix to release tags to avoid EZ-era collisions ([d66247e](https://github.com/TechLateef/EZ/commit/d66247e9531264134fdb2c4a3327ad867a19a6c2))
* **ci:** remove continue-on-error from test steps ([9022bf5](https://github.com/TechLateef/EZ/commit/9022bf5f54f333345e3faa6fbd7bc517b010b5cf))
* clean test .d files in make clean ([2055429](https://github.com/TechLateef/EZ/commit/20554299244d9d1be3971ac76808c7b585265bd7))
* **cli:** embed runtime archive on Windows and shared util headers ([32a60b2](https://github.com/TechLateef/EZ/commit/32a60b20c961c5c025d1ba367167ce75cdce26c3))
* **cli:** extract #doc attributes from file-scope variables ([#2196](https://github.com/TechLateef/EZ/issues/2196)) ([786c724](https://github.com/TechLateef/EZ/commit/786c7241aa5dd096dc1ef22f6d0f8f9e49892d40))
* **cli:** filter releases to grayscale-v* tags, excluding legacy EZ releases ([e3805ce](https://github.com/TechLateef/EZ/commit/e3805ce85040e92ed66499abca72fa2151f5779c))
* **cli:** filter releases to grayscale-v* tags, excluding legacy EZ releases ([#2201](https://github.com/TechLateef/EZ/issues/2201)) ([05636ae](https://github.com/TechLateef/EZ/commit/05636aea32add6fb7983d8abf90964b05927b46e))
* **cli:** locate grayc.exe and accept Windows path patterns ([#1342](https://github.com/TechLateef/EZ/issues/1342)) ([598477d](https://github.com/TechLateef/EZ/commit/598477d531350cf15767518575502311b28f86c9))
* **cli:** prefer a repo-local grayc build over the embedded compiler ([ef9dec3](https://github.com/TechLateef/EZ/commit/ef9dec338fbb8f6f104111d560a9e7ca56051520))
* **cli:** print error message for unknown subcommands ([#2288](https://github.com/TechLateef/EZ/issues/2288)) ([d4a2226](https://github.com/TechLateef/EZ/commit/d4a2226443616205ac742d607d5e67558b74dfc3))
* **cli:** propagate errors to main() instead of calling os.Exit directly ([c23b9e7](https://github.com/TechLateef/EZ/commit/c23b9e797c7ec3322a571b057f71ba5a33f8ddb4))
* **cli:** reject legacy EZ releases in update checks ([e8fa984](https://github.com/TechLateef/EZ/commit/e8fa984037bb0bc1a498d2b10c072bef724dfc00))
* **cli:** reject legacy EZ releases in update version checks ([2aca3cf](https://github.com/TechLateef/EZ/commit/2aca3cfb404bbc9499728ae4f050a66bd0de5c06))
* **cli:** report CPU, RAM, kernel, and compiler on Windows ([3f361cb](https://github.com/TechLateef/EZ/commit/3f361cb4840ace6ccb38b691f674fc6e427a93a2))
* **cli:** restrict project names to ASCII alphanumeric, hyphens, and underscores ([#2175](https://github.com/TechLateef/EZ/issues/2175)) ([09c2392](https://github.com/TechLateef/EZ/commit/09c239264df452c278678a8ebdce11f365f19bd7))
* **cli:** suppress usage text on runtime panic exit ([bc0322b](https://github.com/TechLateef/EZ/commit/bc0322b0ea8fee4f5e6f655aafac5eac6ad602c8))
* **codegen:** add char/byte element types for arrays.append/insert_at/prepend ([#2297](https://github.com/TechLateef/EZ/issues/2297)) ([8092089](https://github.com/TechLateef/EZ/commit/8092089b6ded51acb6d90d528678fadbf1bc9a6b))
* **codegen:** add instance dispatch for struct functions ([134ff8a](https://github.com/TechLateef/EZ/commit/134ff8af291ea02895a6c1b04c87107908bc3f4c))
* **codegen:** add missing element types for arrays.fill ([#2299](https://github.com/TechLateef/EZ/issues/2299)) ([2a52728](https://github.com/TechLateef/EZ/commit/2a52728e1983cecbdbe7f56752a3d084cd509c0a))
* **codegen:** add source location to runtime panics ([#2113](https://github.com/TechLateef/EZ/issues/2113)) ([f1e1790](https://github.com/TechLateef/EZ/commit/f1e17906c147c1140d5bd69e186a5931bcf550af))
* **codegen:** correct buffer size for wildcard function name mangling ([649c958](https://github.com/TechLateef/EZ/commit/649c9588ff48de629a6dadb4ad9a01754cedf783))
* **codegen:** decrement .iterating guard on early return from for_each ([#2163](https://github.com/TechLateef/EZ/issues/2163)) ([ff2581d](https://github.com/TechLateef/EZ/commit/ff2581deb20841ac019003d1225a03e2364f3606))
* **codegen:** emit concrete enum type in arrays.append/insert_at/prepend ([#2242](https://github.com/TechLateef/EZ/issues/2242)) ([7993715](https://github.com/TechLateef/EZ/commit/799371554f70de698e4cb42efb977f2bc5b2ed69))
* **codegen:** emit concrete enum type in arrays.append/insert_at/prepend ([#2242](https://github.com/TechLateef/EZ/issues/2242)) ([0006121](https://github.com/TechLateef/EZ/commit/0006121a7a42e45b5cecfb7416b9b283f675f9ef))
* **codegen:** emit overflow checks for compound assignment through pointer dereference ([#2164](https://github.com/TechLateef/EZ/issues/2164)) ([f3d4624](https://github.com/TechLateef/EZ/commit/f3d4624551f53b1815be13b91584c19deaec12a1))
* **codegen:** emit wide integer intrinsics for struct field access ([#2224](https://github.com/TechLateef/EZ/issues/2224)) ([61d0962](https://github.com/TechLateef/EZ/commit/61d0962fb73844582d250ae53ab3b94d4f1cf8b6))
* **codegen:** evaluate when match expression once into a temporary ([#2126](https://github.com/TechLateef/EZ/issues/2126)) ([50ea594](https://github.com/TechLateef/EZ/commit/50ea594bf5357b7f49b2de934ba84c716fee6905))
* **codegen:** fix codegen issues for windows ([#1342](https://github.com/TechLateef/EZ/issues/1342)) ([3fb960d](https://github.com/TechLateef/EZ/commit/3fb960d39ef82df08aaf440b3ccf819379ed89e2))
* **codegen:** hoist map collection into temporary for for_each iteration ([#2128](https://github.com/TechLateef/EZ/issues/2128)) ([358ff60](https://github.com/TechLateef/EZ/commit/358ff608c9e60c6b08924f13e54da768b926b487))
* **codegen:** include bigint.h unconditionally as a core header ([2c87be0](https://github.com/TechLateef/EZ/commit/2c87be0832c4d4fd2464d02f7b4018f6de07b4e2))
* **codegen:** inject default params for struct function calls ([#2130](https://github.com/TechLateef/EZ/issues/2130)) ([187e5bc](https://github.com/TechLateef/EZ/commit/187e5bc9adf150b2320c5026df4906ca02a88b21))
* **codegen:** inject instance for all struct function dispatch patterns ([42bc3ee](https://github.com/TechLateef/EZ/commit/42bc3eec97e79c3d3c9c06e9c2f257b42ab3949c))
* **codegen:** inject self param for both mutable and immutable struct functions ([5f528e3](https://github.com/TechLateef/EZ/commit/5f528e3b02036aa5e2de9e0a49d56226dc465f1f))
* **codegen:** mangle identifiers the C standard defines as macros ([feeeb04](https://github.com/TechLateef/EZ/commit/feeeb0477edcd30d2108f668a203be22e7035e23))
* **codegen:** materialize rvalue arguments as compound literals ([0370551](https://github.com/TechLateef/EZ/commit/037055173c3bf81efa9ae1b08821b47e4356f8b8))
* **codegen:** pass 64-bit values to upgraded fmt directives ([647456d](https://github.com/TechLateef/EZ/commit/647456d693ef2f99b1fd78146178fd7ceec25fb9))
* **codegen:** preserve module prefix for user-defined types in type resolution ([f19c004](https://github.com/TechLateef/EZ/commit/f19c004312d51660580f78f1ede4d4b1c079cd27))
* **codegen:** prevent infinite recursion in cross-module struct type resolution ([2d333cd](https://github.com/TechLateef/EZ/commit/2d333cdd36c9bb26e2a6351439420de960424901))
* **codegen:** recognize bigint comparisons as bool in println ([#2217](https://github.com/TechLateef/EZ/issues/2217)) ([1307f12](https://github.com/TechLateef/EZ/commit/1307f125933642ba31db46557d13f168629e7d5b))
* **codegen:** resolve struct function names through using-modules ([#2291](https://github.com/TechLateef/EZ/issues/2291)) ([e53c25c](https://github.com/TechLateef/EZ/commit/e53c25c1283fb66d0adf5e1022b0d8622b5ae7b8))
* **codegen:** scope ref_vars and bigint_vars per function to prevent cross-function leaks ([#2142](https://github.com/TechLateef/EZ/issues/2142)) ([6e59b16](https://github.com/TechLateef/EZ/commit/6e59b16582917d0b3aa69ef26e7c7128577ee7bd))
* **codegen:** string() on char now returns the character, not the codepoint ([#2238](https://github.com/TechLateef/EZ/issues/2238)) ([fb2b6fd](https://github.com/TechLateef/EZ/commit/fb2b6fd2e55d528f8c26565a5a1cadbe6048b313))
* **codegen:** use 64-bit shift for flags enum bit values ([#2186](https://github.com/TechLateef/EZ/issues/2186)) ([04facce](https://github.com/TechLateef/EZ/commit/04faccebc2868641a2d2c429ade4ec93de22d798))
* **codegen:** use bigint to_string for wide integer fields in struct printing ([#2230](https://github.com/TechLateef/EZ/issues/2230)) ([ff53192](https://github.com/TechLateef/EZ/commit/ff53192cc03f5331b23202bfdb29e7d2d32db87a))
* **codegen:** use correct C types for wide int arrays.append/insert_at/prepend ([#2298](https://github.com/TechLateef/EZ/issues/2298)) ([f89a3a8](https://github.com/TechLateef/EZ/commit/f89a3a85e93d2abf24981842f5c0d2596248f4ac))
* **codegen:** use correct element size for enum array interpolation ([#2248](https://github.com/TechLateef/EZ/issues/2248)) ([dda344e](https://github.com/TechLateef/EZ/commit/dda344e9f0b69fd488cc676c9f6e7c540b12c8ac))
* **codegen:** use gray_string_concat for interpolation to preserve null bytes ([#2195](https://github.com/TechLateef/EZ/issues/2195)) ([f0951b8](https://github.com/TechLateef/EZ/commit/f0951b8a5ecc84e2d5add5b65727b9859b24ae02))
* **codegen:** wrap left operand in parens for float/unsigned division zero-check ([#2243](https://github.com/TechLateef/EZ/issues/2243)) ([481c8f0](https://github.com/TechLateef/EZ/commit/481c8f0adf7c17ae49e7b805f4e85a3c8b484b52))
* **codegen:** zero-initialize codegen state ([a1284f2](https://github.com/TechLateef/EZ/commit/a1284f23bf38abe9b901f5414e59687eb7b3c638))
* **compiler:** build generated programs with gnu11 and -static on Windows ([7c9a49f](https://github.com/TechLateef/EZ/commit/7c9a49fa42acad28291ab6869660521cfc96d5fd))
* **compiler:** find C compilers that are not on PATH on Windows ([8fd81a5](https://github.com/TechLateef/EZ/commit/8fd81a5be5d5ac602724caf7df5567b808b37c24))
* **compiler:** resolve util headers when building runtime from source ([585fe26](https://github.com/TechLateef/EZ/commit/585fe26b4373c55a8639cce8643ca26a780be2b6))
* **compiler:** suppress -Winfinite-recursion warning from leaking to user output ([#2102](https://github.com/TechLateef/EZ/issues/2102)) ([69729f5](https://github.com/TechLateef/EZ/commit/69729f54a029b0dabeb413386b3a9ff891bd8924))
* correct .gray extension offset and eliminate magic numbers ([#2097](https://github.com/TechLateef/EZ/issues/2097)) ([76545fc](https://github.com/TechLateef/EZ/commit/76545fc79aa463db81f339a91444a82ed840281e))
* correct element type parsing for nested bracket types in array initializers ([2b61fff](https://github.com/TechLateef/EZ/commit/2b61fff149f65a6a4ad6bc9e714ef0f43d0c3272))
* correct lower bound in uint-to-int cast error message ([178bcf3](https://github.com/TechLateef/EZ/commit/178bcf388a51f0c4de690481259182aa7d34f66b))
* E3129 compile error for empty loop bodies ([#2094](https://github.com/TechLateef/EZ/issues/2094)) ([beffb89](https://github.com/TechLateef/EZ/commit/beffb8965631e88d28c250263624f1d95d2b5204))
* emit correct HTTP reason phrase and Location header for redirects ([611016e](https://github.com/TechLateef/EZ/commit/611016ec0ee64f1a3bddced58d4d28b3d8a6ae04))
* emit plain cast for file-scope const sized integers ([#2095](https://github.com/TechLateef/EZ/issues/2095)) ([20b7b6d](https://github.com/TechLateef/EZ/commit/20b7b6defcab22467aa3cd7454b114e5fcd09b1e))
* free global_init buffer in codegen_destroy() ([6b9ea93](https://github.com/TechLateef/EZ/commit/6b9ea93349af0dca1700660d2bdbdee50841aae4))
* heap-allocate builtin struct field arrays to prevent free-of-static crash ([60e273b](https://github.com/TechLateef/EZ/commit/60e273bb9a4c32d241604f3164beb9efff162c6c))
* **imports:** detect module name collisions across import statements ([8e1cca4](https://github.com/TechLateef/EZ/commit/8e1cca47b0c44b0c6b82a408a7d50b70c51aea09))
* improve compiler parsing, HTTP behavior, and CLI safety ([67e1e56](https://github.com/TechLateef/EZ/commit/67e1e564ccc49575ef6f59facef091ed95893bb5))
* initialize ns_func_names fields in codegen_create to prevent garbage free ([1ab0464](https://github.com/TechLateef/EZ/commit/1ab0464c95d21b36884fb5745b0fc58d4944fa64))
* json.encode always quotes map[string:string] values, escape all control chars ([#2019](https://github.com/TechLateef/EZ/issues/2019)) ([c490066](https://github.com/TechLateef/EZ/commit/c490066a89efd5224aede9e83487c3b9f40aa828))
* **lexer,parser:** skip nested strings when tracking interpolation brace depth ([#2161](https://github.com/TechLateef/EZ/issues/2161)) ([6043334](https://github.com/TechLateef/EZ/commit/60433342d30b40cbb4d24d2a14c8d4aeb316b5ab))
* **lexer:** cap identifier length at 255 characters ([#2182](https://github.com/TechLateef/EZ/issues/2182)) ([eef5f87](https://github.com/TechLateef/EZ/commit/eef5f87bc1525836af4b238d04cad51cf0ca0bf7))
* **lexer:** saturate line and column counters at INT_MAX ([#2183](https://github.com/TechLateef/EZ/issues/2183)) ([1209418](https://github.com/TechLateef/EZ/commit/1209418dedcfc93ac0f879ed7cafe73d867ba4fa))
* materialize rvalue for map field access through explicit ptr deref ([#2065](https://github.com/TechLateef/EZ/issues/2065)) ([353b16c](https://github.com/TechLateef/EZ/commit/353b16c3547984450394601b27ab683a15969451))
* parse fixed-size array of maps type annotation [map[K:V], N] ([1b183d1](https://github.com/TechLateef/EZ/commit/1b183d16cab357b796e6c86f1c73c8a266f9f89b))
* **parser:** add recursion depth limit for block statement nesting ([#2168](https://github.com/TechLateef/EZ/issues/2168)) ([738a388](https://github.com/TechLateef/EZ/commit/738a3885ab9ea68f71afd860d5f731c9d44fde50))
* **parser:** cap array type nesting depth at 64 levels ([#2169](https://github.com/TechLateef/EZ/issues/2169)) ([3101a8f](https://github.com/TechLateef/EZ/commit/3101a8f82dea7d5cfb0e02ca42c7b81b46cbd772))
* **parser:** correct or_return fallback count when user provides error value ([#2247](https://github.com/TechLateef/EZ/issues/2247)) ([e0cb3e9](https://github.com/TechLateef/EZ/commit/e0cb3e9a4e4213e25c153c6ca67448ad307ebd4e))
* **parser:** emit E2002 for type keywords as enum binding names ([#2129](https://github.com/TechLateef/EZ/issues/2129)) ([9bfe428](https://github.com/TechLateef/EZ/commit/9bfe428853fc6934c73780bd03f4b6b6c75053a2))
* **parser:** enforce 64KB limit on string interpolation expressions ([#2177](https://github.com/TechLateef/EZ/issues/2177)) ([43e05c3](https://github.com/TechLateef/EZ/commit/43e05c35ca475563bac79f624d967373127f4a04))
* **parser:** handle module-qualified function calls in for_each iterable ([#2245](https://github.com/TechLateef/EZ/issues/2245)) ([a960715](https://github.com/TechLateef/EZ/commit/a960715f19191f90ca2b3c0b4189b6517b839faf))
* **parser:** parse compound types in tagged enum payloads ([#2287](https://github.com/TechLateef/EZ/issues/2287)) ([8789d88](https://github.com/TechLateef/EZ/commit/8789d88652deb3240206be40ec445b50020cc254))
* **parser:** reject wildcard ? in struct field types ([#2079](https://github.com/TechLateef/EZ/issues/2079)) ([f0e55f4](https://github.com/TechLateef/EZ/commit/f0e55f48ecc0840dcfb9cb9e15f08349f35de82f))
* **parser:** replace strdup with arena allocation in error paths ([#2184](https://github.com/TechLateef/EZ/issues/2184)) ([a92d62f](https://github.com/TechLateef/EZ/commit/a92d62ff9fde4ed28166d3accc324988c4260c1d))
* **parser:** support chained member access in for_each collection ([#2190](https://github.com/TechLateef/EZ/issues/2190)) ([2246564](https://github.com/TechLateef/EZ/commit/224656404038a15e2fcbd2af5906fcf4cb8ff574))
* **parser:** use correct length when stripping .gray extension from imports ([b2297f0](https://github.com/TechLateef/EZ/commit/b2297f0d0a66cbfba7552c303c0f42bd07cd8ed6))
* **platform:** clamp size_t to INT_MAX in gray_getcwd() on Windows ([57304a9](https://github.com/TechLateef/EZ/commit/57304a98b3d4c3a6641d292aedbb61ff1c5774ab))
* **platform:** route directory scanning through platform layer ([eaebca3](https://github.com/TechLateef/EZ/commit/eaebca3b3c3596ba6cb7c994a1a844205891ebcd))
* prompt for confirmation before ez pz --force deletes existing directory ([d34a65c](https://github.com/TechLateef/EZ/commit/d34a65cd5e856085b5ace77923e43f2f9dedd3cd))
* reject channels.try_receive() single capture with E3040 instead of C error leak ([#2060](https://github.com/TechLateef/EZ/issues/2060)) ([04d0864](https://github.com/TechLateef/EZ/commit/04d0864f7ef680b9524c4a8d776048529be1fd82))
* reject CORS origins containing CR or LF to prevent HTTP header injection (P0101) ([#2009](https://github.com/TechLateef/EZ/issues/2009)) ([3188d1d](https://github.com/TechLateef/EZ/commit/3188d1d7ab7b176136ae71ecc5532d0087b743e8))
* reject https:// URLs in http module with explicit error instead of silent plaintext fallback ([#2007](https://github.com/TechLateef/EZ/issues/2007)) ([b25c633](https://github.com/TechLateef/EZ/commit/b25c633b6812c83b3d92c526d4a2acfff4609f6a))
* repair result-clobbering NULL and dangling stack pointers in typechecker ([#2040](https://github.com/TechLateef/EZ/issues/2040), [#2045](https://github.com/TechLateef/EZ/issues/2045)) ([e74831a](https://github.com/TechLateef/EZ/commit/e74831a2218effa27963f1924316f3890bdfc90e))
* report 'unexpected end of interpolation expression' instead of EOF in ${...} sub-parser ([#2018](https://github.com/TechLateef/EZ/issues/2018)) ([ef0369d](https://github.com/TechLateef/EZ/commit/ef0369d46d8806bd43127dadb5803935a93402d6))
* resolve rvalue address-of bug in stdlib codegen ([#2053](https://github.com/TechLateef/EZ/issues/2053), [#2052](https://github.com/TechLateef/EZ/issues/2052)) ([2657125](https://github.com/TechLateef/EZ/commit/2657125851c6e9b75bcccc6b3463071999570557))
* resolve string enum element type in array indexing and iteration ([1a0956a](https://github.com/TechLateef/EZ/commit/1a0956a2fb21c16bb3871a2774411c1e779f7a07))
* resolve wildcard-returned enums as TK_ENUM instead of TK_STRUCT ([#2054](https://github.com/TechLateef/EZ/issues/2054)) ([a90e756](https://github.com/TechLateef/EZ/commit/a90e756db0e24193af8c65173ee010613c6481d1))
* **runtime:** add char and byte variants for array contains operator ([d220201](https://github.com/TechLateef/EZ/commit/d22020171492b556bbef0e6ae44c7b4a23827db3))
* **runtime:** add iteration guard to maps.clear ([#2187](https://github.com/TechLateef/EZ/issues/2187)) ([c1eaf00](https://github.com/TechLateef/EZ/commit/c1eaf009dc49cbd23dff9b01650dee9e45553525))
* **runtime:** add memory barrier to ARM64 CAS failure paths ([#2069](https://github.com/TechLateef/EZ/issues/2069)) ([0fd1da3](https://github.com/TechLateef/EZ/commit/0fd1da39a0f3a66548ec167981d87232ae2e8fa3))
* **runtime:** correct 256-bit subtraction borrow propagation ([#2192](https://github.com/TechLateef/EZ/issues/2192)) ([5a77320](https://github.com/TechLateef/EZ/commit/5a77320ec3bd0a306c063b45cc79c076286f4a31))
* **runtime:** include source location in runtime panics ([#2188](https://github.com/TechLateef/EZ/issues/2188)) ([714accf](https://github.com/TechLateef/EZ/commit/714accfe0a21931a2c814aabd2e8e212025f6ffa))
* **runtime:** make spinlock_destroy idempotent to prevent double-free crash ([#2068](https://github.com/TechLateef/EZ/issues/2068)) ([79687e7](https://github.com/TechLateef/EZ/commit/79687e71f2e68c19b8cc29763ba99c9ab45eb7c7))
* **runtime:** panic on wide integer division by zero ([#2178](https://github.com/TechLateef/EZ/issues/2178)) ([7056543](https://github.com/TechLateef/EZ/commit/7056543dc7f7f8d9f4648eb04038dfe6a3a97e4d))
* **runtime:** prevent int32 overflow in array capacity doubling ([#2166](https://github.com/TechLateef/EZ/issues/2166)) ([c16947b](https://github.com/TechLateef/EZ/commit/c16947b3d6ce01e49e15be1fb0e31ac441af31bd))
* **runtime:** prevent size_t overflow in arena allocation check ([#2171](https://github.com/TechLateef/EZ/issues/2171)) ([5001941](https://github.com/TechLateef/EZ/commit/50019413f4818cb000c485d90f1eecfd7c2c9295))
* **runtime:** shim isatty/STDERR_FILENO through platform_rt.h ([9b21b40](https://github.com/TechLateef/EZ/commit/9b21b40425173d9578e6f4e14c865c40adda6b7a))
* **runtime:** use correct atomic primitives on Windows ([#1342](https://github.com/TechLateef/EZ/issues/1342)) ([4b28d24](https://github.com/TechLateef/EZ/commit/4b28d24d692179c97c0b440c5002ad58a74bf86d))
* **runtime:** use source file paths in panic messages instead of generated C paths ([560ceec](https://github.com/TechLateef/EZ/commit/560ceec805d0c4bc271c2a657960a425d05edcce))
* **runtime:** use unsigned limb arithmetic in i128 add/sub/neg ([5ad92a7](https://github.com/TechLateef/EZ/commit/5ad92a7ed6906a5fbe4143cc8f201e35f4468061))
* **runtime:** validate digits in bigint decimal parser ([#2179](https://github.com/TechLateef/EZ/issues/2179)) ([9ded657](https://github.com/TechLateef/EZ/commit/9ded657ebfd2a1593e7d561982dd83b20670cee7))
* send HTTP request headers and body separately to remove 8KB body size limit ([#2013](https://github.com/TechLateef/EZ/issues/2013)) ([8df4f3e](https://github.com/TechLateef/EZ/commit/8df4f3edfbb94298d3bb67b937bc8aff03983121))
* **stdlib:** add parameterized query API to sqlite module ([#1690](https://github.com/TechLateef/EZ/issues/1690)) ([55930b0](https://github.com/TechLateef/EZ/commit/55930b09376b7c21fd4950ec86357901c7c14941))
* **stdlib:** add parameterized query API to sqlite module ([#1690](https://github.com/TechLateef/EZ/issues/1690)) ([b772cc7](https://github.com/TechLateef/EZ/commit/b772cc7174003eabf196d372e1df125f7a6cf097))
* **stdlib:** eliminate TOCTOU race in thread detach cleanup ([#2181](https://github.com/TechLateef/EZ/issues/2181)) ([99d3080](https://github.com/TechLateef/EZ/commit/99d308028eaf77fb30c1477f63fee99fb8275eab))
* **stdlib:** reach the system math.h from the math module header ([05e0f72](https://github.com/TechLateef/EZ/commit/05e0f72872b269f279ef40f53be086834b13b235))
* **stdlib:** resolve isfinite linker failure on macOS arm64 ([700fa79](https://github.com/TechLateef/EZ/commit/700fa79b34f913166e4524acb5755379c918e867))
* **stdlib:** respect explicit seed in rand64 for deterministic output ([#2231](https://github.com/TechLateef/EZ/issues/2231)) ([6c3af87](https://github.com/TechLateef/EZ/commit/6c3af87fc8cfe227deaa09e5ad1da47e55f2b1a4))
* **stdlib:** seed PRNG with arc4random/urandom instead of time(NULL) ([#2180](https://github.com/TechLateef/EZ/issues/2180)) ([fb64fff](https://github.com/TechLateef/EZ/commit/fb64fffd60d6113f71a4dc3a32ceda401c9cba2b))
* **stdlib:** unescape doubled quotes in csv.parse() quoted fields ([#2239](https://github.com/TechLateef/EZ/issues/2239)) ([84561c0](https://github.com/TechLateef/EZ/commit/84561c0fd0fd7322a7c7160aa71a37f5959bdd7e))
* **stdlib:** unescape doubled quotes in csv.parse() quoted fields ([#2239](https://github.com/TechLateef/EZ/issues/2239)) ([cc184a8](https://github.com/TechLateef/EZ/commit/cc184a8995277c8e76605ac240d6d8394a753260))
* **stdlib:** use 64-bit RNG in rand_int for full-range support ([#2231](https://github.com/TechLateef/EZ/issues/2231)) ([eef9972](https://github.com/TechLateef/EZ/commit/eef99720b04cdf275a3925c64a9f0ddc091fffbc))
* **stdlib:** use overflow-checked subtraction in time.diff ([#2067](https://github.com/TechLateef/EZ/issues/2067)) ([328f2be](https://github.com/TechLateef/EZ/commit/328f2be6b809e558f3ebbe4ed80a74903ee9d1de))
* **stdlib:** use platform temp directory in io temp functions ([1f25608](https://github.com/TechLateef/EZ/commit/1f2560899965ad1fc4ef9524baba1bcc8b55d657))
* **stdlib:** use the system CSPRNG for random seeding on Windows ([ce46d5d](https://github.com/TechLateef/EZ/commit/ce46d5d46d8ecb75fac769b047736c6482fa50be))
* **stdlib:** use the system CSPRNG for uuid and crypto on Windows ([d2e9d57](https://github.com/TechLateef/EZ/commit/d2e9d573d8c37b6639f073b8e8c21458d019aa3c))
* **stdlib:** use Win32 Sleep() for sleep builtins on Windows ([edfd3ca](https://github.com/TechLateef/EZ/commit/edfd3caf320f903895fd03a31d84976eba7a7aad))
* strdup type_array inputs and resolve remaining free-of-non-heap crashes ([ca7aa46](https://github.com/TechLateef/EZ/commit/ca7aa46dffcc595affb2cf3b5e24f991ae73d4a8))
* strip \$ escape in codegen so escaped interpolation emits valid C ([#2077](https://github.com/TechLateef/EZ/issues/2077)) ([da10377](https://github.com/TechLateef/EZ/commit/da103771d39627a21b919c41aa14203e0b250126))
* **tests:** correct e2e test count double-counting in test_e2e_divide_by_zero ([46acb35](https://github.com/TechLateef/EZ/commit/46acb35afd6ad1909ace5e10e73da326c3e05603))
* **tests:** register unused buffer test functions in test_util ([e55acf1](https://github.com/TechLateef/EZ/commit/e55acf14381556dd6c97b201045a5cbe5a2a481d))
* **tests:** resolve 6 failing integration tests ([5f20f14](https://github.com/TechLateef/EZ/commit/5f20f14a35f201e08ad25fed270761b976d2c4c1))
* **tests:** update tests for narrowing checks on reassignment ([7d3c9cc](https://github.com/TechLateef/EZ/commit/7d3c9ccf20b376f3dbd2a499a8d1e1b9db451dae))
* **test:** use correct endpoint for HEAD request in http_custom_headers ([7e9e89c](https://github.com/TechLateef/EZ/commit/7e9e89c5b15f0f8f9d3920caf952a562e9382508))
* track and free struct-namespaced function name strings in codegen ([480c807](https://github.com/TechLateef/EZ/commit/480c80772fc1de968ec7511e1067514b0c80377d))
* track wide integers in const table and emit compound literals at file scope ([#2096](https://github.com/TechLateef/EZ/issues/2096)) ([de4ed9b](https://github.com/TechLateef/EZ/commit/de4ed9b4d952b43e8ab9c3de48d16c2e7c5337e8))
* typecheck index argument in arrays.remove_at() and arrays.insert_at() ([97f4244](https://github.com/TechLateef/EZ/commit/97f4244f82a667f2076b9e1b12abe2d8e46a2bae))
* **typechecker,codegen:** allow explicit type annotations for stdlib opaque types ([#2216](https://github.com/TechLateef/EZ/issues/2216)) ([f946806](https://github.com/TechLateef/EZ/commit/f9468068cd25e375ed62ca297e66449455afa6be))
* **typechecker:** add arg type validation for stdlib functions missing coverage ([d3a4114](https://github.com/TechLateef/EZ/commit/d3a41149527235299af8f41a61bd244dc55d513d))
* **typechecker:** add child scopes for while and loop bodies ([#2127](https://github.com/TechLateef/EZ/issues/2127)) ([aa7e86e](https://github.com/TechLateef/EZ/commit/aa7e86e1a23e2559c08271e2bc7600d34514d991))
* **typechecker:** add E3100 check for type names in struct-namespaced calls ([#2229](https://github.com/TechLateef/EZ/issues/2229)) ([eee3976](https://github.com/TechLateef/EZ/commit/eee3976942255df58a3c8ba4c893d14a0da69d46))
* **typechecker:** allow addr() on const variables, catch mutation at write sites ([#2191](https://github.com/TechLateef/EZ/issues/2191)) ([626809a](https://github.com/TechLateef/EZ/commit/626809aa99d4ad7d67ed34251c4eaa300a90d1a9))
* **typechecker:** allow bitwise operators on #flags enums ([#2133](https://github.com/TechLateef/EZ/issues/2133)) ([a57e764](https://github.com/TechLateef/EZ/commit/a57e764954ec33329e2e042f8181f8950e326ac9))
* **typechecker:** allow explicit deref before struct function calls ([#2244](https://github.com/TechLateef/EZ/issues/2244)) ([06e6ab6](https://github.com/TechLateef/EZ/commit/06e6ab69644a77dbf730e8a090a9e1067d47d72f))
* **typechecker:** auto-deref pointer receivers for struct function dispatch ([#2131](https://github.com/TechLateef/EZ/issues/2131)) ([889be08](https://github.com/TechLateef/EZ/commit/889be0838463c699a006b9e3a82434ad79e70e02))
* **typechecker:** catch const mutation through nested access and postfix ([#2162](https://github.com/TechLateef/EZ/issues/2162)) ([dbb9df5](https://github.com/TechLateef/EZ/commit/dbb9df5a0a497ab507da09a82c5081546634c544))
* **typechecker:** correct E3001 narrowing hint to use cast() syntax ([#2264](https://github.com/TechLateef/EZ/issues/2264)) ([77a78ba](https://github.com/TechLateef/EZ/commit/77a78ba3feed89e232cc989f3ce1e274524398bb))
* **typechecker:** emit E3027 for non-self instance dispatch with & params ([#2116](https://github.com/TechLateef/EZ/issues/2116)) ([3df4549](https://github.com/TechLateef/EZ/commit/3df4549148a66645a46aafad4e9bf4e8b65d1410))
* **typechecker:** emit E3040 for multi-return calls in aggregate contexts ([#2114](https://github.com/TechLateef/EZ/issues/2114)) ([013566b](https://github.com/TechLateef/EZ/commit/013566b05edbaed10ff5af6aca4a55a086c65b7d))
* **typechecker:** emit E3130 for bare func as struct field type ([#2121](https://github.com/TechLateef/EZ/issues/2121)) ([ec7232c](https://github.com/TechLateef/EZ/commit/ec7232c3df53423d55f10def71aa4d8b7282e098))
* **typechecker:** emit W3005 for implicit enum selectors and tagged enum patterns in when/is ([#2259](https://github.com/TechLateef/EZ/issues/2259)) ([1b28944](https://github.com/TechLateef/EZ/commit/1b2894418b9f1367719bc71e8dcebac2352e3356))
* **typechecker:** propagate const_source through pointer assignment ([#2211](https://github.com/TechLateef/EZ/issues/2211)) ([d232152](https://github.com/TechLateef/EZ/commit/d23215257ce89e2b1bd6244eaddb8909a0c91447))
* **typechecker:** register inferred-type vars from wildcard expressions ([#2080](https://github.com/TechLateef/EZ/issues/2080)) ([19b05ee](https://github.com/TechLateef/EZ/commit/19b05ee5de1e62ce506e4f048380fe8a4adb84f3))
* **typechecker:** reject array reassignment with mismatched element types ([#2235](https://github.com/TechLateef/EZ/issues/2235)) ([b2a471d](https://github.com/TechLateef/EZ/commit/b2a471d7e57ae9e8a2d33560fd25abf4a021a81a))
* **typechecker:** reject cross-enum type reassignment ([#2234](https://github.com/TechLateef/EZ/issues/2234)) ([176309c](https://github.com/TechLateef/EZ/commit/176309ccafb13fe0e4514c1159ea90aa8f89100d))
* **typechecker:** reject global constant forward references ([#2132](https://github.com/TechLateef/EZ/issues/2132)) ([05865bc](https://github.com/TechLateef/EZ/commit/05865bc378e2af9a243b024fad2a3e37e6785ddb))
* **typechecker:** reject map reassignment with mismatched key or value types ([#2236](https://github.com/TechLateef/EZ/issues/2236)) ([fa29783](https://github.com/TechLateef/EZ/commit/fa29783df29a4bae360be338d6222f0feee1510e))
* **typechecker:** reject multi-return functions in 5 expression contexts ([#2260](https://github.com/TechLateef/EZ/issues/2260)) ([fdbeeb4](https://github.com/TechLateef/EZ/commit/fdbeeb488b8ec534db34da97fad99843cc6a37bf))
* **typechecker:** reject numeric reassignment with narrowing or signedness mismatch ([#2232](https://github.com/TechLateef/EZ/issues/2232)) ([8de1c91](https://github.com/TechLateef/EZ/commit/8de1c91288988156d63be4c70927bfc174d8a4f2))
* **typechecker:** reject runtime function calls in const initializers ([#2104](https://github.com/TechLateef/EZ/issues/2104)) ([00aa411](https://github.com/TechLateef/EZ/commit/00aa411da4effdddd34141f2b4fc08750f807172))
* **typechecker:** reject tagged enums in interpolation and map values ([#2261](https://github.com/TechLateef/EZ/issues/2261)) ([de576aa](https://github.com/TechLateef/EZ/commit/de576aab0f162b82fe70362dde93b46ae738ee2b))
* **typechecker:** remove dead E3067, fix E4021 cross-module match, rename E4006 test ([#2226](https://github.com/TechLateef/EZ/issues/2226)) ([1844f8a](https://github.com/TechLateef/EZ/commit/1844f8a50863487063230295957bdec42e3f68fe))
* **typechecker:** require explicit type on file-scope const primitives ([#2120](https://github.com/TechLateef/EZ/issues/2120)) ([9d6504b](https://github.com/TechLateef/EZ/commit/9d6504bd6642eeb71988d43d522a311271fed517))
* **typechecker:** resolve embed() paths through the platform layer ([#1342](https://github.com/TechLateef/EZ/issues/1342)) ([3627c66](https://github.com/TechLateef/EZ/commit/3627c664151bd92bea602eaff8faf2be65cbd155))
* **typechecker:** resolve implicit enum selectors in map key bracket access ([#2246](https://github.com/TechLateef/EZ/issues/2246)) ([93732d9](https://github.com/TechLateef/EZ/commit/93732d93ad4995a711376c3c03489eeb9986146f))
* **typechecker:** resolve implicit enum selectors in map key bracket access ([#2246](https://github.com/TechLateef/EZ/issues/2246)) ([126f6fc](https://github.com/TechLateef/EZ/commit/126f6fc4799e26ad3c9a137dfac811d45b9f3eed))
* **typechecker:** resolve implicit enum selectors in map literal values ([#2249](https://github.com/TechLateef/EZ/issues/2249)) ([ceaddcd](https://github.com/TechLateef/EZ/commit/ceaddcd1885866439659383d49d4a888c8743753))
* **typechecker:** resolve implicit enum selectors in struct field defaults ([#2223](https://github.com/TechLateef/EZ/issues/2223)) ([96a410e](https://github.com/TechLateef/EZ/commit/96a410e7ed9df9ec8c01aa1aa97f614d7a61cc86))
* **typechecker:** resolve implicit enum selectors in struct field defaults ([#2223](https://github.com/TechLateef/EZ/issues/2223)) ([98763db](https://github.com/TechLateef/EZ/commit/98763db7fb010afb0c129576addeddf81715ab18))
* **typechecker:** resolve type aliases in map key validation and map value lookup ([#2237](https://github.com/TechLateef/EZ/issues/2237)) ([c1ebcab](https://github.com/TechLateef/EZ/commit/c1ebcab7109728cf5c19887a22f8d1f11eb7ac99))
* **typechecker:** restore struct context during generic re-check to prevent spurious E4017 ([#2197](https://github.com/TechLateef/EZ/issues/2197)) ([fb6e62f](https://github.com/TechLateef/EZ/commit/fb6e62fa1d2804e7be6742fed7b122c07c6e067a))
* **typechecker:** revert [#2149](https://github.com/TechLateef/EZ/issues/2149) optimization that caused NULL result segfault ([0fa296b](https://github.com/TechLateef/EZ/commit/0fa296b80bc52dd5334b2b19f55441888642f8b5))
* **typechecker:** route instance dispatch through semantic analysis ([10c48b3](https://github.com/TechLateef/EZ/commit/10c48b357ef7c64cd5919ceaf3cc911252fec817))
* **typechecker:** support type parameter forwarding between generic functions ([#2059](https://github.com/TechLateef/EZ/issues/2059)) ([376fc83](https://github.com/TechLateef/EZ/commit/376fc8340ce98362c834f00f784b9de29debd60d))
* **typechecker:** unify cross-module enum type identity ([bffb8b0](https://github.com/TechLateef/EZ/commit/bffb8b0b74db21be191da911879f95766283a44b))
* **typechecker:** unify cross-module enum type identity ([#2290](https://github.com/TechLateef/EZ/issues/2290)) ([7de0d67](https://github.com/TechLateef/EZ/commit/7de0d6784d9e3b163dff8a9b3d6d3403f5daf840))
* **typechecker:** validate arg types for time.diff, os.set_env, os.unset_env ([#2064](https://github.com/TechLateef/EZ/issues/2064)) ([ef12499](https://github.com/TechLateef/EZ/commit/ef12499c9c2c534696cfabca80c383c0a6e99c80))
* **typechecker:** validate arrays.map callback return type matches element type ([#2240](https://github.com/TechLateef/EZ/issues/2240)) ([1f8ef21](https://github.com/TechLateef/EZ/commit/1f8ef21ad753558003b341b89d3f8969be0157d6))
* **typechecker:** validate arrays.map callback return type matches element type ([#2240](https://github.com/TechLateef/EZ/issues/2240)) ([5e5c711](https://github.com/TechLateef/EZ/commit/5e5c711102f7af1e34a2ba6b0b8d6c04ecfdfe67))
* **typechecker:** validate arrays.reduce callback return type matches accumulator ([#2241](https://github.com/TechLateef/EZ/issues/2241)) ([ef4ca05](https://github.com/TechLateef/EZ/commit/ef4ca05e95bd791e82153a5fe4649252d2f9e640))
* **typechecker:** validate arrays.reduce callback return type matches accumulator ([#2241](https://github.com/TechLateef/EZ/issues/2241)) ([27b7f28](https://github.com/TechLateef/EZ/commit/27b7f2859923f85488196c7cdc414a1ae72a1245))
* **typechecker:** validate callback param types for arrays.any/all/filter/map/reduce ([#2063](https://github.com/TechLateef/EZ/issues/2063)) ([ba32c3e](https://github.com/TechLateef/EZ/commit/ba32c3ee9c71eef0a83cf9fd00a6239c32007bf8))
* **typechecker:** validate types for compound assignment operators ([#2125](https://github.com/TechLateef/EZ/issues/2125)) ([307ce27](https://github.com/TechLateef/EZ/commit/307ce27ff66157d151d55b5cb14aab06ea66f531))
* use arena allocation for named-arg reorder buffer in tc_resolve_named_args() ([58cc8b4](https://github.com/TechLateef/EZ/commit/58cc8b4aad74b134fec8db07566a8b30472e50c7))
* use correct C type for integer enum array element access ([bb62a4a](https://github.com/TechLateef/EZ/commit/bb62a4a37b72b85bc7fd00bda908b5456d9195d2))
* use lvalue check in addr-of wrapping to preserve mutation semantics ([#2053](https://github.com/TechLateef/EZ/issues/2053), [#2052](https://github.com/TechLateef/EZ/issues/2052)) ([c8becba](https://github.com/TechLateef/EZ/commit/c8becbaf1d4e5f61c0ec77ed195aa9cd32f6caa3))
* validate Channel type for first arg of all channels functions ([#2061](https://github.com/TechLateef/EZ/issues/2061)) ([e9269d2](https://github.com/TechLateef/EZ/commit/e9269d258729ab3eef0be8d8c24cc6afe5311f34))
* warn when ez doc --output writes outside the current directory ([83adb16](https://github.com/TechLateef/EZ/commit/83adb1661159d57bddfc0dcc0a8a030b18d60b3a))


### Performance Improvements

* add early-out for equal names in tc_same_enum_type and tc_same_struct_type ([#2043](https://github.com/TechLateef/EZ/issues/2043)) ([79d9dc3](https://github.com/TechLateef/EZ/commit/79d9dc3e73d0e92f6b25b60e3921c0bd4cadc11a))
* add parallel index array to find_enum_index to eliminate O(n) scan after bsearch ([#2042](https://github.com/TechLateef/EZ/issues/2042)) ([963cbfc](https://github.com/TechLateef/EZ/commit/963cbfca6da9f3bc3f69bd85bd02295cf7b4ac0d))
* cache tc_lookup_using_constant result to avoid double call ([#2040](https://github.com/TechLateef/EZ/issues/2040)) ([180d0d7](https://github.com/TechLateef/EZ/commit/180d0d794fc002cade869c814b34f38a116dd86c))
* **codegen:** single categorization pass over program statements ([#2148](https://github.com/TechLateef/EZ/issues/2148)) ([4a0ffc6](https://github.com/TechLateef/EZ/commit/4a0ffc6d66f82815aa6f4634945e93be70be6cd3))
* eliminate O(n) inner loop in tc_lookup_using_constant via pre-computed import index ([#2041](https://github.com/TechLateef/EZ/issues/2041)) ([ce92138](https://github.com/TechLateef/EZ/commit/ce921380d323f847601c8cb8c343fb544db9a964))
* fix several remaining memory leaks in typechecker and codegen ([5f513eb](https://github.com/TechLateef/EZ/commit/5f513eb055c4511cea4da502c80f9fb974d77bcf))
* **parser:** remove prescan that double-lexed entire source file ([#2143](https://github.com/TechLateef/EZ/issues/2143)) ([cc102eb](https://github.com/TechLateef/EZ/commit/cc102eb7a36ce80e675b404f0ef37ae059bb4a3f))
* replace 202 unconditional stack diagnostic buffers with arena allocation via tc_fmt helper ([#2044](https://github.com/TechLateef/EZ/issues/2044)) ([287ec00](https://github.com/TechLateef/EZ/commit/287ec00c0a1a618770de997617e0efa3df3ba274))
* replace strlen+sprintf heap allocs with snprintf into stack buffer in name-mangling paths ([#2045](https://github.com/TechLateef/EZ/issues/2045)) ([1ee7731](https://github.com/TechLateef/EZ/commit/1ee77310ecb043954076183602dcc228b0817d9b))
* **runtime:** add gray_arena_alloc_uninitialized to eliminate redundant zeroing ([#2151](https://github.com/TechLateef/EZ/issues/2151)) ([567ef36](https://github.com/TechLateef/EZ/commit/567ef36d082865aed8c84c511123571b58ce91e1))
* **typechecker:** cache typechecker_lookup_using_constant result ([#2149](https://github.com/TechLateef/EZ/issues/2149)) ([ad26cf3](https://github.com/TechLateef/EZ/commit/ad26cf3fbc73036d696596c5d477fd913403e812))
* **typechecker:** free owned ret_types arrays in scope_destroy ([#2071](https://github.com/TechLateef/EZ/issues/2071)) ([663dba1](https://github.com/TechLateef/EZ/commit/663dba162c8e96e1cfbf4fd50a6f92c21208949f))
* **typechecker:** table-driven stdlib return type resolution ([#2145](https://github.com/TechLateef/EZ/issues/2145)) ([6b5c27c](https://github.com/TechLateef/EZ/commit/6b5c27cf2459bc5f850cd5ab420d21f29eea0f1f))
